(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["pages-2ptescrow-tab3sending-module"],{

/***/ "./src/app/pages/2ptescrow/tab3sending.module.ts":
/*!*******************************************************!*\
  !*** ./src/app/pages/2ptescrow/tab3sending.module.ts ***!
  \*******************************************************/
...
/* harmony import */ var _tab3sending_page__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./tab3sending.page */ "./src/app/pages/2ptescrow/tab3sending.page.ts");
...
/***/ "./src/app/pages/2ptescrow/tab3sending.page.html":
/*!*******************************************************!*\
  !*** ./src/app/pages/2ptescrow/tab3sending.page.html ***!
  \*******************************************************/
...
module.exports = "div {\n  font-size: 0.875em; }\n\n.welcome-card ion-img {\n  max-height: 35vh;\n  overflow: hidden; }\n\nion-textarea {\n  background: var(--ion-color-medium);\n  border-radius: 20px; }\n\nion-input {\n  background: var(--ion-color-medium);\n  border-radius: 20px; }\n\n/*# sourceMappingURL=data:application/json;base64, */"

/***/ }),

/***/ "./src/app/pages/2ptescrow/tab3sending.page.ts":
/*!*****************************************************!*\
  !*** ./src/app/pages/2ptescrow/tab3sending.page.ts ***!
  \*****************************************************/
...
var Tab3sendingPage = /** @class */ (function () {
    function Tab3sendingPage(blue011issue, blue011consume, activateservice, alertController, modalController, invoiceservice, blue011web, changellyCalls, recordService, logger, policyService, kycService, webuserservice, termsuserservice, router, storage) {
        ...
        this.directpurpose = '';
        this.revertpurpose = '';
        this.twopescrowfeaturetype = '';
        this.torevertamount = 0.000;
        this.samplemessage2 = "Dear sammy \n" +
            "An escrow is created with address \n" +
            "fund is received to start the work \n" +
            "you will be credited funds upon completion of work  \n" +
            "report your completed work by email for validation  \n" +
            "your completion code to get funds will be sent to you in SMS \n" +
            "upon successful validation of your work \n" +
            "            \n" +
            "Escrow team \n" +
            "Regards ";
        this.samplemessage1 = "Dear bob \n" +
            "An escrow is created with address \n" +
            "deposit funds to start the work \n" +
            "the funds will be used after completion of work  \n" +
            "fund will be spent upon validation  \n" +
            "unutilised fund will be returned  \n" +
            "            \n" +
            "Escrow team \n" +
            "Regards ";
    ...
    Tab3sendingPage.prototype.getdefinv = function () {
        ...
        this.invoiceservice.getdefaultinvtemplate().then(function (xx) {
            ...
            if (_this.defaultinvoice.default2pescrowtemplate) {
                _this.invoicerequest.templatenumber = _this.defaultinvoice.default2pescrowtemplate.templatenumber;
                _this.invoicerequest.templatetype = _this.defaultinvoice.default2pescrowtemplate.templatetype;
            }
            else {
    ...
    Tab3sendingPage.prototype.sendparty2note = function (msg) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            ...
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                ...
                this.blue011web.webdocemail(data, '/webtool/webescrowsendparty2note').then(function (controldata) {
    ...
    Tab3sendingPage.prototype.sendescrowreport = function (msg) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var data;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                ...
                this.blue011web.webdocemail(data, '/webtool/websendescrowreport').then(function (controldata) {
                    _this.displayemailmsg();
                    //   this.senddisable = false;
                }).catch(function (err1) {
                });
    ...
    Tab3sendingPage.prototype.sendinvoice = function (msg) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            ...
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                ...
                this.blue011web.webdocemail(data, '/webtool/webescrowsendinvoice').then(function (controldata) {
                    _this.displayemailmsg();
                    //   this.senddisable = false;
                }).catch(function (err1) {
                });
                ...
                switch (_b.label) {
                    ...
                    case 5:
                        ...
                        data = {
                            ...
                            twopescrowfeaturetype: this.twopescrowfeaturetype,
                        ...
                        this.blue011web.webdocemail(data, '/webtool/webescrowsendemail').then(function (controldata) {
                            _this.displayemailmsg();
                            //   this.senddisable = false;
                        }).catch(function (err1) {
                            //   this.senddisable = false;
        ...
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            ...
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                ...
                */
                ...
                // web2ptescrowpayparty
                this.activateservice.consumemessage(this.revertible, '/webactive/web2ptescrowreturnfunds').then(function (data1) {
                    if (data1 != null) {
                        var data;
    ...
    Tab3sendingPage = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
            ...
            template: __webpack_require__(/*! ./tab3sending.page.html */ "./src/app/pages/2ptescrow/tab3sending.page.html"),
            styles: [__webpack_require__(/*! ./tab3sending.page.scss */ "./src/app/pages/2ptescrow/tab3sending.page.scss")]
        }),
...
//# sourceMappingURL=pages-2ptescrow-tab3sending-module.js.map