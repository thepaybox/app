(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["pages-npnote-tab3sending-module"],{

/***/ "./src/app/pages/npnote/tab3sending.module.ts":
/*!****************************************************!*\
  !*** ./src/app/pages/npnote/tab3sending.module.ts ***!
  \****************************************************/
...
/* harmony import */ var _tab3sending_page__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./tab3sending.page */ "./src/app/pages/npnote/tab3sending.page.ts");
...
/***/ "./src/app/pages/npnote/tab3sending.page.html":
/*!****************************************************!*\
  !*** ./src/app/pages/npnote/tab3sending.page.html ***!
  \****************************************************/
...
module.exports = "div {\n  font-size: 0.875em; }\n\n.welcome-card ion-img {\n  max-height: 35vh;\n  overflow: hidden; }\n\nion-textarea {\n  background: var(--ion-color-medium);\n  border-radius: 20px; }\n\nion-input {\n  background: var(--ion-color-medium);\n  border-radius: 20px; }\n\n/*# sourceMappingURL=data:application/json;base64, */"

/***/ }),

/***/ "./src/app/pages/npnote/tab3sending.page.ts":
/*!**************************************************!*\
  !*** ./src/app/pages/npnote/tab3sending.page.ts ***!
  \**************************************************/
...
var Tab3sendingPage = /** @class */ (function () {
    function Tab3sendingPage(blue011issue, blue011consume, alertController, activateservice, modalController, invoiceservice, blue011web, changellyCalls, recordService, logger, policyService, kycService, webuserservice, termsuserservice, router, storage) {
        ...
        this.samplemessage = "Dear sammy \n" +
            "Please pay an amount of 10$ for the sample you requested \n" +
            "Regards ";
        this.issued = {
            "id": "",
            "message": "",
    ...
    Tab3sendingPage.prototype.getdefinv = function () {
        ...
        this.invoiceservice.getdefaultinvtemplate().then(function (xx) {
            ...
            if (_this.defaultinvoice.defaultnpnotetemplate) {
                _this.invoicerequest.templatenumber = _this.defaultinvoice.defaultnpnotetemplate.templatenumber;
                _this.invoicerequest.templatetype = _this.defaultinvoice.defaultnpnotetemplate.templatetype;
            }
            else {
                ...
                switch (_b.label) {
                    ...
                    case 5:
                        ...
                        data = {
                            ...
                            npnotefeaturetype: this.npnotefeaturetype,
                        ...
                        this.blue011web.webdocemail(data, '/webtool/webnpnotesendemail').then(function (controldata) {
    ...
    Tab3sendingPage.prototype.sendnote = function (msg) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var data;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                ...
                this.blue011web.webdocemail(data, '/webtool/webnpsendnote').then(function (controldata) {
                    _this.displayemailmsg();
                    //   this.senddisable = false;
                }).catch(function (err1) {
                });
    ...
    Tab3sendingPage.prototype.sendinvoice = function (msg) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            ...
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                ...
                this.blue011web.webdocemail(data, '/webtool/webnpsendinvoice').then(function (controldata) {
                    _this.displayemailmsg();
                    //   this.senddisable = false;
                }).catch(function (err1) {
                });
        ...
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            ...
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                ...
                */
                ...
                this.activateservice.consumemessage(this.revertible, '/webactive/webnpnoteconsume').then(function (data1) {
                    if (data1 != null) {
                        var data;
    ...
    Tab3sendingPage = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
            ...
            template: __webpack_require__(/*! ./tab3sending.page.html */ "./src/app/pages/npnote/tab3sending.page.html"),
            styles: [__webpack_require__(/*! ./tab3sending.page.scss */ "./src/app/pages/npnote/tab3sending.page.scss")]
        }),
...
//# sourceMappingURL=pages-npnote-tab3sending-module.js.map